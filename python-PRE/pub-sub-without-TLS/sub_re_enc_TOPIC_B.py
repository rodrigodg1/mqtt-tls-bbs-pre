...
def on_message(client, userdata, msg):
    ...
    lat_gps = all_data['Lat_GPS']
    capsule_gps_lat = all_data['Capsule_gps_lat']

    long_gps = all_data['Long_GPS']
    capsule_gps_long = all_data['Capsule_gps_long']
