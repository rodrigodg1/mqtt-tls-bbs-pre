...
def on_message(client, userdata, msg):
    ...
    client.publish("deleg_sub_a", "Message From PRE Software")

# ************------------------------************
  
    #PROCESS PRE OPERTIONS HERE

# ************------------------------************


    #client.publish("deleg_sub_a", str(msg.payload))

    #client.publish("deleg_sub_a","new data from PRE code")
