...
function types(clone, label) {
  ...
  test(`${label} copies buffers from object correctly`, async ({
    ok,
    is,
    isNot,
  }) => {
    ...
    isNot(
      clonedBuffer,
      inputBuffer,
      "cloned buffer is not same as input buffer"
    );
    is(clonedBuffer.toString(), input, "cloned buffer content is correct");
  });
  test(`${label} copies buffers from arrays correctly`, async ({
    ok,
    is,
    isNot,
  }) => {
  ...
  test(`${label} copies TypedArrays from object correctly`, async ({
    ok,
    is,
    isNot,
  }) => {
  ...
  test(`${label} copies TypedArrays from array correctly`, async ({
    ok,
    is,
    isNot,
  }) => {
  ...
  test(`${label} copies complex TypedArrays`, async ({
    ok,
    deepEqual,
    is,
    isNot,
    ...
    deepEqual(
      Array.from(cloned.view1),
      [input1, 0],
      "cloned value content is correct"
    );
    deepEqual(
      Array.from(cloned.view2),
      [input2, input3],
      "cloned value content is correct"
    );
    deepEqual(
      Array.from(cloned.view3),
