...
function Map(container, cmp) {
  ...
  this.getElementByKey = function (element) {
    ...
    if (
      (curNode === null || curNode === void 0 ? void 0 : curNode.key) ===
        undefined ||
      (curNode === null || curNode === void 0 ? void 0 : curNode.value) ===
        undefined
    )
      throw new Error("unknown error");
  ...
  this.getHeight = function () {
    ...
    var traversal = function (curNode) {
      if (!curNode) return 1;
      return (
        Math.max(traversal(curNode.leftChild), traversal(curNode.rightChild)) +
        1
      );
    };
